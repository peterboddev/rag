...
// src/lambda/chunking-config-get.ts
var chunking_config_get_exports = {};
__export(chunking_config_get_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(chunking_config_get_exports);
